...
│   └── SettingSlider.qml, ChoiceRow.qml, DropdownRow.qml, ToggleRow.qml, WidgetRow.qml   # Rows of the settings panel
...
│   │       ├── CpuUsage, RamUsage, DiskUsage, NetworkSpeed, Volume, NotificationBell
│   │       └── PowerMenu
...
| Widgets | Each bar widget | Off, or Left / Center / Right, and its place there | the original layout |
...
| Notifications | Do not disturb | on / off | off |
